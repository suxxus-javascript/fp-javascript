...
// Exercise 4:
// ============
// Write a function: sanitizeNames() using compose that takes an arra
// of cars and returns a list of lowercase and underscored names:
...
var availablePrices = _.compose(
    _.join(', '),
    map(x => accounting.formatMoney(_.prop('dollar_value', x))),
